...
for mask in range(32):
    net=ip_network(f'145.192.186.230/{mask}',0)
    print(net.netmask,net)


'''
60)	В терминологии сетей TCP/IP маска сети – это двоичное число, меньшее 2**32; 
...
Для узла с IP-адресом 145.192.186.230 адрес сети равен 145.192.160.0. Чему равен третий слева байт маски? Ответ запишите в виде десятичного числа.
'''