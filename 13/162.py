...
k=0
for i in ip_network('202.75.38.160/255.255.255.240',0):
    b=f'{i:b}'
    if '111' in b:
        k+=1
print(k)
'''
162)	(К. Багдасарян) В терминологии сетей TCP/IP маской сети называют двоичное число, которое показывает,
