...
k=0
for ip in ip_network(f'202.75.38.176/255.255.255.240'):
    b=f'{ip:b}'
...
'''
161)	(К. Багдасарян) В терминологии сетей TCP/IP маской сети называют двоичное число, 
...
Сеть задана IP-адресом 202.75.38.176 и маской сети 255.255.255.240. 
