...
for n in range(1,10000):
    ...
    b=bin(n)[2:]
    b = ('10' if b.count('1') % 4 == 0 else '11')+b
    b+= '0' if b[-1]=='1' else '1'
    r=int(b,2)
    if r<250:
        a.append(n)
...
'''
327)	(Е. Джобс) На вход алгоритма подаётся натуральное число N. Алгоритм строит по нему новое число R следующим образом:
...
Например, для числа 13 = 11012 получается 11110102 = 122, для числа 10 = 10102 получается 11101012 = 117. 
